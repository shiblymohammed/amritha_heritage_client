    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[90vh] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-foreground-on-color px-6 animate-fadeInUp">
          ...
          >
            Celebrate life's special occasions in the timeless elegance of our heritage property. From intimate gatherings to grand celebrations, we provide the perfect backdrop for your memorable events.
          </motion.p>
          <motion.div 
            className="opacity-0"
            initial={{ opacity: 0, y: 20 }}
