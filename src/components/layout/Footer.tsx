          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className={`mt-16 pt-8 border-t border-border/50 flex flex-col lg:flex-row justify-between items-center gap-8 ${getAnimClass(500)}`}>
              ...
              <div className="flex items-center space-x-3">
                <SocialIcon href="https://www.facebook.com/amrithaheritagetvm" title="Facebook"><FacebookIcon /></SocialIcon>
                <SocialIcon href="https://www.instagram.com/amrithaheritage/" title="Instagram"><InstagramIcon /></SocialIcon>
              </div>
            </div>
          </div>
        </div>
