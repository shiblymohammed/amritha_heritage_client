...
function Footer() {
  ...
  return (
    <>
      ...
      <footer
        ref={footerRef}
        className="relative bg-background pt-24 lg:pt-40 -mt-20 overflow-hidden"
      >
        ...
        {/* Main Content Area */}
        <div className="relative bg-background-secondary pt-20 lg:pt-32 pb-12 px-6 md:px-8 footer-wave-clip">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center md:text-left">
              ...
              >
                <div className={getAnimClass(100)}>
                  <Link to="/" className="inline-block mb-6 animate-float">
                    <h2 className="text-3xl font-cinzel tracking-widest text-foreground text-glow-gold">
                      AMRITHA HERITAGE
                    </h2>
                    <p className="text-sm font-poppins tracking-wider text-accent uppercase">
                      THIRUVANANTHAPURAM
                    </p>
                  </Link>
                  <p className="font-cormorant text-foreground-subtle leading-relaxed max-w-sm mx-auto md:mx-0">
                    A sanctuary of timeless elegance, preserving rich colonial
                    history for the modern discerning traveler.
                  </p>
                </div>
              </div>
              ...
              <div
                ...
                className={getAnimClass(400)}
              >
                <h3 className="font-playfair text-h4 text-foreground mb-6">
                  Stay Connected
                </h3>
                <p className="font-cormorant text-foreground-subtle mb-4">
                  Receive heritage insights and exclusive offers.
                </p>
                <form className="flex max-w-sm mx-auto md:mx-0">
                  ...
                  <button
                    type="submit"
                    className="btn btn-primary px-5 rounded-r-md rounded-l-none animate-float"
                  >
                    Join
                  </button>
                </form>
            ...
            <div
              className={`mt-16 pt-8 border-t border-border/50 flex flex-col lg:flex-row justify-between items-center gap-8 ${getAnimClass(
                500
              )}`}
            >
              <p className="text-sm font-poppins text-foreground-subtle text-center lg:text-left">
                © {new Date().getFullYear()} Amritha Heritage. All Rights
                Reserved.
              </p>
